export const appartmentList = [
  ...
  },
  {
    ...
    description:
      "Idéalement situé Ã  2 pas de la place de la République, ce studio particulièrement fonctionnel est parfait pour découvrir Paris. Proche de tous les points d'intérêts grâce aux 5 lignes de métro qui sont à 5 minutes, vous pourrez rentabiliser votre temps passé Ã  la capitale.",
    host: {
      name: 'Sarah Devit',
      picture:
